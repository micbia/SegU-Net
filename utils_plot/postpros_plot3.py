...
loss_imgSeg, val_loss_imgSeg = np.loadtxt('out_imgSeg_loss_ep-%d.txt' %epoch), np.loadtxt('val_out_imgSeg_loss_ep-%d.txt' %epoch)
loss_imgRec, val_loss_imgRec = np.loadtxt('out_imgRec_loss_ep-%d.txt' %epoch), np.loadtxt('val_out_imgRec_loss_ep-%d.txt' %epoch)
#loss_rec, val_loss_rec = np.loadtxt('out_recAstro_loss_ep-%d.txt' %epoch), np.loadtxt('val_out_recAstro_loss_ep-%d.txt' %epoch)
...
ax1.semilogy(val_loss_imgSeg, color='cornflowerblue', label='val loss imgSeg', ls='--',  marker='o')  
ax1.semilogy(val_loss_imgRec, color='cornflowerblue', label='val loss imgRec', ls='--',  marker='s')  
...
ax1.semilogy(loss_imgSeg, color='navy', label='loss imgSeg', marker='o') 
ax1.semilogy(loss_imgRec, color='navy', label='loss imgRec', marker='s') 
...
metric_imgSeg, val_metric_imgSeg = np.loadtxt('out_imgSeg_iou_ep-%d.txt' %epoch), np.loadtxt('val_out_imgSeg_iou_ep-%d.txt' %epoch)
metric_imgRec, val_metric_imgRec = np.loadtxt('out_imgRec_r2score_ep-%d.txt' %epoch), np.loadtxt('val_out_imgRec_r2score_ep-%d.txt' %epoch)
#metric_rec, val_metric_rec = np.loadtxt('out_recAstro_r2score_ep-%d.txt' %epoch), np.loadtxt('val_out_recAstro_r2score_ep-%d.txt' %epoch)
#metric, val_metric = 0.4*(metric_imgSeg+metric_imgRec) + 0.2*metric_rec, 0.4*(val_metric_imgSeg+val_metric_imgRec) + 0.2*val_metric_rec
metric, val_metric = 0.5*(metric_imgSeg+metric_imgRec), 0.5*(val_metric_imgSeg+val_metric_imgRec) 
ax2.plot(metric, color='darkorange', label=r'$R^2$')
ax2.plot(metric_imgSeg, color='darkorange', label=r'$R^2$ imgSeg', marker='o')
ax2.plot(metric_imgRec, color='darkorange', label=r'$R^2$ imgRec', marker='s')
#ax2.plot(metric_rec, color='darkorange', label=r'$R^2$ params', marker='^')
ax2.plot(val_metric, color='tab:orange', ls='--')
ax2.plot(val_metric_imgSeg, color='tab:orange', ls='--',  marker='o')
ax2.plot(val_metric_imgRec, color='tab:orange', ls='--',  marker='s')
...
#print('Validation\tAccuracy\tLoss\n imgSeg:\t%.2f%%\t\t%.4e\n imgRec:\t%.2f%%\t\t%.4e\n params:\t%.2f%%\t\t%.4e\n' %(100*val_metric_imgSeg[idx_best_mode], val_loss_imgSeg[idx_best_mode], 100*val_metric_imgRec[idx_best_mode], val_loss_imgRec[idx_best_mode], 100*val_metric_rec[idx_best_mode], val_loss_rec[idx_best_mode]))
print('Validation\tAccuracy\tLoss\n imgSeg:\t%.2f%%\t\t%.4e\n imgRec:\t%.2f%%\t\t%.4e\n' %(100*val_metric_imgSeg[idx_best_mode], val_loss_imgSeg[idx_best_mode], 100*val_metric_imgRec[idx_best_mode], val_loss_imgRec[idx_best_mode]))
